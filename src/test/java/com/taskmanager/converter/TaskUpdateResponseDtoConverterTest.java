...
class TaskUpdateResponseDtoConverterTest {

    @InjectMocks
    private TaskUpdateResponseDtoConverter converter;
    ...
    void convert() {
        ...
        assertEquals("Задача " + expected.getNumber() + " успешно обновлена", actual.getAlerts().get(0).getMsg());
    }
}